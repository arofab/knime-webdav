...
/**
 * <code>NodeFactory</code> for the "WebDAVRemoteFile" Node.
 * 
 *
 * @author Fabrizio.Arosio
 */
public class HTTPWebDAVConnectionInformationNodeFactory 
        extends NodeFactory<ConnectionInformationNodeModel> {
    ...
    public ConnectionInformationNodeModel createNodeModel() {
        return new ConnectionInformationNodeModel(WebDAVRemoteFileHandler.WEBDAV_PROTOCOL);
    }
    ...
    public NodeDialogPane createNodeDialogPane() {
    	return new ConnectionInformationNodeDialog(WebDAVRemoteFileHandler.WEBDAV_PROTOCOL);
    }
}
